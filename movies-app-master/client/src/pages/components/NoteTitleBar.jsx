  ...
  return (
    <div className={classes.grow}>
      <AppBar position="static" style={style}>
        ...
        <Link color="inherit" href="/" onClick={handleClick}> Daily</Link>
        <Link color="inherit" onClick={handleClick}>Weekly</Link>
        <Typography color="textPrimary">Monthly</Typography>
        </Breadcrumbs>

        <Typography variant="h6" className={classes.title} >April 2020</Typography>
